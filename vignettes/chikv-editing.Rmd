...
rse_ranges <- rowRanges(mm_rse_filt)
db_levels <- seqlevels(tx_db)
rse_ranges <- rse_ranges[seqnames(rse_ranges) %in% db_levels]

VariantAnnotation::locateVariants(rse_ranges, tx_db, AllVariants())
```

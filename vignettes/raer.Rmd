...
```{r}
deobj <- prep_for_de(se_filtered, min_prop = 0.05, min_samples = 3)
...
At this stage, you can use the object to perform DE yourself or you can continue with our functions. For differential editing, we use the design `design <- ~0 + condition:sample + condition:count` and perform testing to compare the edited read counts against unedited read counts. 

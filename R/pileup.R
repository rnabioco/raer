...
#'  to set
#' @param event_filters integer vector of length 7 with values indicating
...
get_pileup <- function(bamfiles,
  ...
  if(!is.logical(only_keep_variants)){
    stop("only_keep_variants must be a logical value or vector ")
              ...
              length(only_keep_variants) != 1){
    stop("either 1 value or a value for every bamfile must be supplied to only_keep_variants")
  } else {

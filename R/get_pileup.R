...
#' @param required_flags bam tags required, pass as integer flag value
#' @param filter_flags bam tags to filter, pass as integer flag value
...
get_pileup <- function(bamfile,
  ...
  res <- run_pileup(bampaths = bamfile,
                    ...
                    required_flags = as.character(required_flags),
                    filter_flags = as.character(filter_flags),

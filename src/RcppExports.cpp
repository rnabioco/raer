...
// run_pileup
int run_pileup(std::string bampath, std::string fapath, std::string region);
RcppExport SEXP _rino_run_pileup(SEXP bampathSEXP, SEXP fapathSEXP, SEXP regionSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::traits::input_parameter< std::string >::type bampath(bampathSEXP);
    Rcpp::traits::input_parameter< std::string >::type fapath(fapathSEXP);
    Rcpp::traits::input_parameter< std::string >::type region(regionSEXP);
    rcpp_result_gen = Rcpp::wrap(run_pileup(bampath, fapath, region));
    return rcpp_result_gen;
END_RCPP
}
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_rino_run_pileup", (DL_FUNC) &_rino_run_pileup, 3},
    {NULL, NULL, 0}
};

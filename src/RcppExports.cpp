...
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(run_pileup(bampaths, fapath, region, outfn, bedfn, min_reads, event_filters, min_mapQ, bam_flags, libtype, max_depth, min_baseQ, n_align, n_align_tag, only_keep_variants, reads, ext));

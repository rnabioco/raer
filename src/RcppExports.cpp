...
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(run_pileup(bampaths, fapath, region, bedfn, min_reads, event_filters, min_mapQ, bam_flags, libtype, outfns, only_keep_variants, read_bqual_filter, max_depth, min_baseQ, reads, bad_reads, ext));
    return rcpp_result_gen;
END_RCPP
}
// get_region
